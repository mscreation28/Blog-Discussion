        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlogCategory = table.Column<string>(nullable: true),
                    BlogLikeCount = table.Column<int>(nullable: false),
                    BlogCreateDate = table.Column<DateTime>(nullable: false),
                    BlogPublished = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NotificationId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(nullable: true),
                    NotificationLabel = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplyLikeCount = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
